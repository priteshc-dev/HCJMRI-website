...
function showMap(location) {
  var mapUrls = {
    'pune': 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d30264.83781273894!2d73.875649!3d18.524169!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf2e67461101%3A0x828d43bf9d9ee343!2sPune%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1749188109006!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade', // Pune Map URL
    'kolhapur': 'https://www.google.com/maps/oSVvPSnbunysRDfc6...', // Kolhapur Map URL
    'nagpur': 'https://www.google.com/maps/embed?...' // Nagpur Map URL
  };
...
function calculate() {
  ...
  if (!preWeight || !currentWeight || !heightCm || !lmpInput) {
  ...
  if (isNaN(lmpDate)) {
    outputDiv.innerHTML = "<span style='color:red;'>Invalid LMP date.</span>";
    return;
  }
  ...
  if (diffMs < 0) {
    outputDiv.innerHTML = "<span style='color:red;'>LMP date cannot be in the future.</span>";
    return;
  }

  const gestDays = Math.floor(diffMs / (1000 * 60 * 60 * 24));
  const gestWeeks = Math.floor(gestDays / 7);
  const extraDays = gestDays % 7;
  ...
  // Determine BMI category for weight gain recommendation
  ...
  // BMI classifications based on updated definitions
  let whoClass = "";
  ...
  // Build output string with recommended ranges included
  let output = `
  ...
  if (gestWeeks >= 14) {
    const weeksIn23Trimester = gestWeeks - 13 + extraDays / 7;
